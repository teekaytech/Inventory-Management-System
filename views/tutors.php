...
<div id="content" class="content">
    ...
    <section>
        ...
        <section class="mx-4 my-4">
            <h3>All Tutors Page</h3>(create new, enable/disable existing, see existing)
        </section>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <select class="form-control" id="courses" name="course_id" required>
                                    ...
                                    <?php foreach ($page->all_courses() as $course) { ?>
                                        <option value="<?php echo $course['id']-1; ?>"><?php echo $course['name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <button type="submit" name="create_tutor" class="btn btn-primary">Create New Tutor</button>
                    </form>
                </article>
            </div>
            <div class="col-md-6">
